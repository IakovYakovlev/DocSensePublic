...
{
    public class UltraPlanStrategy : BasePlanStrategy
    {
        protected override string PlanType => "ultra";

        public UltraPlanStrategy(IFileReaderService reader, IPlanRepository planRepo,
